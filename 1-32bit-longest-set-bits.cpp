...
int main() {
    ...
    std::cout << "Number: " << num1 << " (binary: " << std::bitset<32>(num1) << ")" << std::endl;
...
/*
    ...
    std::cout << "Number: " << num2 << " (binary: " << std::bitset<32>(num2) << ")" << std::endl;
    std::cout << "Longest run: Length " << len2 << ", from index " << start2 << " to " << end2 << std::endl << std::endl;

    uint32_t num3 = 0b11111110000000000000000000000001; // Long run at the top
    auto [len3, start3, end3] = find_longest_consecutive_ones_32(num3);
    std::cout << "Number: " << num3 << " (binary: " << std::bitset<32>(num3) << ")" << std::endl;
    ...
    std::cout << "Number: " << num4 << " (binary: " << std::bitset<32>(num4) << ")" << std::endl;
    std::cout << "Longest run: Length " << len4 << ", from index " << start4 << " to " << end4 << std::endl << std::endl;
    */
    return 0;
}
